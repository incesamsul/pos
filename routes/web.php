...
Route::group(['middleware' => ['auth', 'ceklevel:Administrator']], function () {
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::get('/menu/{id_menu}', [MenuController::class, 'menu']);

        // CRUD MENU
        Route::post('/tambah_menu', [MenuController::class, 'tambahMenu']);
        Route::post('/ubah_menu', [MenuController::class, 'ubahMenu']);
        Route::get('/hapus_menu/{id_kategori}', [MenuController::class, 'hapusMenu']);
